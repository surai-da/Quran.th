...
<style>
  ...
  border:#00CC00 dotted 1px; 
    ...
    <br>
    <br>
 <div style = background-color:#ccfff2; class="search-area">
 <div class="row">
    <div class="col-md-8 mx-auto"> <!-- กรอบหน้าซูเราะห์แต่ละซูเราะห์ -->
<br>
<br>
...
<!-- dropdown surah&& ayah : can link-->
    <div style =background-color:#ccfff2; class="col-md-3 ">
...
<br>
<!-- detail The Quran -->
         <h4 class="arabic text-center " >[{{$arabics->surah_arab}}]{{$arabics->th_name}}</h4> <!-- top name surah -->
         <br> 


<div style =background-color:#ccfff2; class=" list-group list-group-horizontal justify-content-center">         
<!-- read quran-->
...
<!-- เริ่มซูเราะห์-->
        ...
        <div class="quran-font-intro "> <!-- การโชว์ arabic text -->
        <p>
        {{$arabic->text}}
        </p>
      
       </div>
       <p class="t">{{$arabic->transliteration}}</p> <!-- การโชว์ คำอ่านกุรอาน -->
